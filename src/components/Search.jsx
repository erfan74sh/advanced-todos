...
const Search = () => {
	...
	return (
		<div className="w-full sm:w-auto max-w-screen-sm sm:max-w-md flex-shrink flex rounded-md flex-grow focus-within:ring-2 bg-slate-50 transition-colors duration-300">
			<label
				htmlFor="search"
